...
#define GRAVITY_Y -15.81f

#define PIXELS_PER_METER 50.0f // if touched change METER_PER_PIXEL too
#define METER_PER_PIXEL 0.02f // this is 1 / PIXELS_PER_METER !
#define VPIXEL_PER_METERS 100.0f //
#define METERS_PER_VPIXEL 0.02 //

#define METERS_TO_PIXELS(m) ((int) floor(PIXELS_PER_METER * m))
#define PIXEL_TO_METERS(p)  ((float) METER_PER_PIXEL * p)
#define VPIXEL_PER_METERS(vp) ((float) METERS_PER_VPIXEL * vp)
...
public:
	...
	PhysBody* CreateChain(int x, int y, int* points, int size, float restitution, b2BodyType type = b2_staticBody);
